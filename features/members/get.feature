Feature: Members get
  ...
  Scenario: As anonymous, I cannot get a member
    When I send a "GET" request to "/api/members/2"
  ...
  Scenario Outline: As a member, I cannot get a banned or invalid member
    Given I am authenticated as "member-2"
    And I add "Accept" header equal to "application/ld+json"
    When I send a "GET" request to "/api/members/<id>"
  ...
  Scenario: As a member, I can get any valid member
    Given I am authenticated as "member-2"
    And I add "Accept" header equal to "application/ld+json"
  ...
  Scenario Outline: As a member, I cannot get an inactive, unverified or invisible member by its username
    Given I am authenticated as "member-2"
    And I add "Accept" header equal to "application/ld+json"
